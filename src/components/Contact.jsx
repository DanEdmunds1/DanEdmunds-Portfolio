...
export default function Contact() {
    ...
    return (
        ...
        <div><img src={linkedin} alt="linkedin-icon"/><span>:</span><a href="mailto:dan.edmunds7@gmail.com">LinkedIn</a></div>

        <div><img src={github} alt="github-icon"/><span>:</span><a href="mailto:dan.edmunds7@gmail.com">GitHub</a></div>
        </div>
        </>
    )
}